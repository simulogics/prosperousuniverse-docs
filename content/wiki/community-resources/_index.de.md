...
| Guide | Beginners Guide   | [Steam Community Guide](https://steamcommunity.com/sharedfiles/filedetails/?id=3545186148) | Laaxus ausführliche Anleitung für Beginner                                         |  
| Guide | Governor Guide    | [Web Link](https://oogcapitalmanagement.com/posts/good-governance/)                        | Regierungsleitfaden: Als Governour durchstarten.                                   |

## Tools

| Typ               | Name                            | Autor                         | Link                                                                                                                                                                                | Beschreibung                                                                                                            |
|-------------------|---------------------------------|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
| Extension/Utility | FIO                             | Kovus, Saganaki, viele andere | https://fio.fnar.net/                                                                                                                                                               | Suchen Sie Planeten, finden Sie Transportanzeigen, überprüfen Sie Ihren Verbrauch an Versorgungsgütern und vieles mehr. |
| Extension         | Refined Prun                    | Razenpok                      | [Chrome Web Store](https://chromewebstore.google.com/detail/refined-prun/coabeheneafgglpakallmkienlidgaof), [Firefox](https://addons.mozilla.org/en-US/firefox/addon/refined-prun/) | Browser Extension die viele Verbesserungen für APEX enthält                                                             |
...
| Map               | Shipping Tracker                | OptimizedFunction             | https://tracking.benten.space/                                                                                                                                                      | Karte um Lieferungen zu verfolgen                                                                                       |
...
| Utility           | OOG Tools                       | Archiel                       | [OOG Tools](https://oogcapitalmanagement.com/tools/)                                                                                                                                | Various tools: Verschiedene Tools rund um Spielerdetails, Effizienzberechnungen usw.                                    |
| Utility           | Profitable Prun                 | Jackinabox                    | https://profitableprun.com/                                                                                                                                                         | Verschiedene Tools rund um Inflationsberechnung, Profit pro Fläche und weitere.                                         |
| Utility           | PU Price Model                  | Taiyi                         | https://benten.space/calculator/pricecalc                                                                                                                                           | Ein Preismodell basierend auf diesem [paper](https://benten.space/price_prediction_study.pdf).                          |
...
|-----------------|-----------------------------|---------------------------------|--------------------------------------------------------------------|
| FIO Rest API    | Kovus, Saganaki, and others | https://rest.fnar.net           | Die weitverbreitete REST API um verschiedene Spieldaten abzurufen. |
| FIO API (new)   | Kovus, Saganaki, and others | https://api.fnar.net/index.html | Ein teilweise vollständiger Erstatz für die FIO REST API.          |
| PRUNplanner API | Scorpio, and others         | https://prunplanner.org/api     | API für PRUNplanner                                                |
